 ...
 * This implementation uses a simple pattern matching approach for an offline chatbot
 * In a real application, you would integrate with a proper offline LLM like llama.cpp or similar
 */
...
export const generateChatbotResponse = async (message) => {
...
export const getPageSuggestions = (currentPage) => {
  switch (currentPage) {
    case 'home':
